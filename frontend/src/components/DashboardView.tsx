/**
 * Dashboard por persona (broadcaster / scout / coach / fan).
 * Consome GET /api/dashboard/{role}. Extraído do App.tsx original para conviver
 * com as demais views em abas.
 */
      ...
      <main>
        ...
        {error && (
          <div>
            ...
            <p className="muted">
              A API está no ar?{" "}
              <code>cd backend; .venv\Scripts\uvicorn app.main:app --reload</code>
            </p>
          </div>
        )}
